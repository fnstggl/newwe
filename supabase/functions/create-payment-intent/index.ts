...
serve(async (req) => {
  ...
  try {
    ...
    if (billing_cycle === 'monthly') {
      ...
      priceAmount = 1800; // $18.00 in cents
      interval = 'year';
    }
    
    logStep("Pricing determined", { billing_cycle, priceAmount, interval });
    ...
    logStep("Price created", { priceId: price.id, interval, amount: priceAmount });
