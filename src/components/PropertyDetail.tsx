...
{/* Attribution watermark - always visible in bottom left */}
<div className="absolute bottom-2 left-2 text-white text-[10px] z-30 pointer-events-none">
