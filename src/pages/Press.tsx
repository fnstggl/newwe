    ...
    <div className="min-h-screen bg-black text-white font-inter">
      ...
      <section className="py-20 px-4 bg-gray-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
            ...
            <p>
              Realer Estate is an AI-powered platform that scans NYC listings in real time to surface rent-stabilized and undervalued apartments—before they disappear. It's already helped over 21,000 New Yorkers search for more affordable homes, and we're just getting started.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="p-6 rounded-xl bg-black/50 border border-gray-800 hover:border-blue-500/40 transition-all">
            <div className="text-2xl font-bold mb-2">21,000+ New Yorkers</div>
