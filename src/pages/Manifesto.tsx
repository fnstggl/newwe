    ...
    <div className="min-h-screen bg-black text-white font-inter">
      <div className="max-w-4xl mx-auto px-4 py-8 md:py-16">
        ...
        <div className="text-center mb-8 md:mb-16">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-8 tracking-tighter">
            The game is rigged.
            <br />
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          <div className="mb-8 md:mb-12">
            <p className="text-lg md:text-xl leading-relaxed mb-4 md:mb-6 text-gray-300 tracking-tight">
          ...
          <div className="bg-gray-900/50 rounded-2xl p-4 md:p-8 mb-8 md:mb-12 border border-gray-800">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6 tracking-tighter">
              Using advanced algorithms to find you the BEST deal in the city.
            </h2>
            <p className="text-base md:text-lg text-gray-300 leading-relaxed tracking-tight">
          ...
          <blockquote className="border-l-4 border-blue-500 pl-4 md:pl-8 py-4 mb-8 md:mb-12 bg-blue-500/5 rounded-r-xl">
            <p className="text-xl md:text-2xl font-semibold text-blue-400 mb-2 tracking-tight">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 mb-8 md:mb-12">
            <div className="bg-gray-900/50 rounded-xl p-4 md:p-6 border border-gray-800">
              <h3 className="text-lg md:text-xl font-bold mb-3 tracking-tight">The Problem</h3>
          ...
          <div className="text-center bg-gradient-to-r from-blue-600/10 to-purple-600/10 rounded-2xl p-4 md:p-8 border border-blue-500/20 mb-8 md:mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 tracking-tighter">
              It's time buyers had the edge.
            </h2>
            <p className="text-base md:text-lg text-gray-300 mb-4 md:mb-6 tracking-tight">
              Stop playing a rigged game. Start winning with data.
            </p>
            <a 
              href="/join"
          ...
          {/* Disclaimer */}
          <div className="text-center mt-8 md:mt-16 pt-6 md:pt-8 border-t border-gray-800">
