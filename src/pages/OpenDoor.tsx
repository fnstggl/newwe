      ...
      <div className="max-w-4xl mx-auto px-8 py-20">
        <div className="mb-16">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-100 mb-4 font-inter font-bold uppercase tracking-wide">Realer Estate. For everyone.</p>
          </div>
        </div>
        ...
        <div className="text-center mb-16">
          <div className="max-w-3xl mx-auto p-8 bg-gray-900 border border-gray-700 rounded-lg shadow-sm">
            ...
            <p className="text-white text-lg font-medium">
              No credit cards. No fine print. Just a better way to help fight housing insecurity.
            </p>
          </div>
        </div>
