        ...
        <div className="relative w-full max-w-7xl mx-auto rounded-3xl overflow-hidden">
          ...
          backgroundImage: `url('/lovable-uploads/2ff24928-306a-4305-9c27-9594098a543d.png')`
            ...
            <div className="relative z-10 text-left px-12 py-20 max-w-4xl">
              ...
              <Link to="/search" className="inline-block bg-white text-black px-6 py-3 rounded-full font-semibold text-base -bottom-40 hover:-bottom-40 hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl">
                Start Searching
              </Link>
            </div>
          </div>
