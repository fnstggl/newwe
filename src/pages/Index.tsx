      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-xl border-t border-gray-800/50">
        <div className="flex items-center justify-around py-2 px-4 safe-area-pb">
          ...
          >
            ...
            <span className="text-xs text-gray-400 font-medium tracking-tight">Buy</span>
          </button>
          ...
          >
            ...
            <span className="text-xs text-white font-medium tracking-tight">Rent</span>
          </button>
          ...
          >
            ...
            <span className="text-xs text-gray-400 font-medium tracking-tight">Saved</span>
          </button>
          ...
          >
            ...
            <span className="text-xs text-gray-400 font-medium tracking-tight">Upgrade</span>
          </button>
          ...
          >
            ...
            <span className="text-xs text-gray-400 font-medium tracking-tight">Mission</span>
          </button>
        </div>
      </div>
    </div>
