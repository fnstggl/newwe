...
<section className="relative min-h-[600px] flex items-center justify-center overflow-hidden px-0 pt-0">        {/* Background Image with Full Width */}
        <div className="absolute inset-0 w-full h-full">
          ...
          <div className="relative z-10 min-h-[600px] flex items-center justify-center">
            <div className="text-center px-4 py-20 max-w-5xl">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-inter font-semibold mb-4 tracking-[-0.075em] transform translate-y-[150px] text-white">
                Your unfair advantage in real estate.
              </h1>
              <p className="text-lg md:text-xl mb-12 md:mb-16 text-white opacity-80 font-inter font-medium transform translate-y-[150px] tracking-[-0.075em]">
      ...
      <section className="py-12 md:py-20 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-8 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold mb-4 md:mb-6 tracking-tighter">
            It shouldn't be this hard to find a home in NYC.
          </h2>
          <p className="text-lg md:text-xl text-gray-400 tracking-tight max-w-3xl mx-auto">
        ...
        <div className="h-px bg-gradient-to-r from-transparent via-blue-500 to-transparent my-6 md:my-8"></div>
      </section>

      {/* How It Works */}
      <section className="py-12 md:py-20 px-4 bg-gray-900/50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-center mb-8 md:mb-16 tracking-tighter">
            The real estate game is rigged. Now you can win. 
          </h2>
          <div className="grid md:grid-cols-3 gap-4 md:gap-8">
            <div className="text-center p-4 md:p-8 rounded-2xl bg-black/50 hover:bg-black/70 transition-all duration-300 hover:scale-105 border border-gray-800 hover:border-transparent hover:shadow-[0_0_20px_rgba(59,130,246,0.4)] hover:ring-2 hover:ring-blue-500/30">
              <h3 className="text-xl md:text-2xl font-semibold mb-2 md:mb-4 tracking-tight">We analyze the data</h3>
              <p className="text-sm md:text-base text-gray-400 tracking-tight">Real-time scraping of listings and analysis of comps, market trends to identify true value.</p>
            </div>
            <div className="text-center p-4 md:p-8 rounded-2xl bg-black/50 hover:bg-black/70 transition-all duration-300 hover:scale-105 border border-gray-800 hover:border-transparent hover:shadow-[0_0_20px_rgba(59,130,246,0.4)] hover:ring-2 hover:ring-blue-500/30">
              <h3 className="text-xl md:text-2xl font-semibold mb-2 md:mb-4 tracking-tight">We find the hidden gems</h3>
              <p className="text-sm md:text-base text-gray-400 tracking-tight">Advanced algorithms identify undervalued properties you'd never find.</p>
            </div>
            <div className="text-center p-4 md:p-8 rounded-2xl bg-black/50 hover:bg-black/70 transition-all duration-300 hover:scale-105 border border-gray-800 hover:border-transparent hover:shadow-[0_0_20px_rgba(59,130,246,0.4)] hover:ring-2 hover:ring-blue-500/30">
              <h3 className="text-xl md:text-2xl font-semibold mb-2 md:mb-4 tracking-tight">You buy smarter</h3>
              <p className="text-sm md:text-base text-gray-400 tracking-tight">Skip overpriced listings and focus on real opportunities.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-20 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-8 md:mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6 max-w-4xl mx-auto mb-8 md:mb-12">
            <div className="p-4 md:p-6 rounded-xl bg-gradient-to-r from-blue-600/10 to-purple-600/10 border border-blue-500/20 hover:border-blue-500/40 transition-all">
              <h3 className="text-lg md:text-xl font-semibold mb-2 tracking-tight">SoHo</h3>
              <p className="text-sm md:text-base text-gray-400 tracking-tight">Avg $2,100/sqft → Deals from $1,350</p>
            </div>
            <div className="p-4 md:p-6 rounded-xl bg-gradient-to-r from-blue-600/10 to-purple-600/10 border border-blue-500/20 hover:border-blue-500/40 transition-all">
              <h3 className="text-lg md:text-xl font-semibold mb-2 tracking-tight">Bushwick</h3>
              <p className="text-sm md:text-base text-gray-400 tracking-tight">Avg $930/sqft → Deals from $690</p>
            </div>
          </div>
          <Link to="/rent">
      ...
      {/* Final CTA */}
      <section className="py-12 md:py-20 pb-0 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-8 md:mb-12 tracking-tight">
            Join the platform that actually works for buyers.
          </p>
          <Link to="/join" className="inline-block bg-white text-black px-6 md:px-8 py-3 md:py-4 rounded-full font-semibold text-lg tracking-tight hover:shadow-[0_0_15px_rgba(255,255,255,0.8)] transition-all duration-300 shadow-xl">
            Join now.
          </Link>
          
          {/* Footer Links */}
          <div className="mt-8 md:mt-16 mb-2">
            <div className="flex justify-center space-x-6 md:space-x-8 text-xs text-gray-400">
