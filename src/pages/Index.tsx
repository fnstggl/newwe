        ...
        <div className="relative w-full max-w-7xl mx-auto rounded-3xl overflow-hidden">
          ...
          >
            ...
            <div className="relative z-10 text-center px-12 py-20 max-w-4xl">
              ...
              <Link 
                to="/search" 
                className="inline-block bg-white font-inter text-black px-6 py-3 rounded-full font-semibold tracking-tighter hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl">
                Start Searching
              </Link>
            </div>
          </div>
