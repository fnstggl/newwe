        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          <div className="relative z-10 min-h-[600px] flex items-center justify-center">
            <div className="text-center px-4 py-20 max-w-5xl">
              ...
              <Link to={user ? "/rent" : "/join"} className="inline-block bg-white font-inter text-black px-12 py-5 rounded-full font-bold text-xl tracking-tighter transform translate-y-[130px] hover:shadow-[0_0_15px_rgba(255,255,255,0.8)] transition-all duration-300 shadow-xl">
