...
interface AuthContextType {
  ...
  signUp: (email: string, password: string, name: string) => Promise<{ error: any; isNewUser?: boolean }>;
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const signUp = async (email: string, password: string, name: string) => {
    ...
    // Return whether this is a new user signup
    const isNewUser = data?.user && !error;
